...
> **Note**: For practical implementation guides, see the [Getting Started](getting-started.html) vignette. For method-specific details, see [Lewbel GMM](lewbel-gmm.html), [Rigobon](rigobon-method.html), or [Prono](prono-method.html) vignettes.
...
$$
\begin{align}
&\frac{\text{Cov}(Z,W_1W_2)^2}{\text{Cov}(Z,W_2^2)^2} - \frac{\text{Var}(W_1W_2)}{\text{Var}(W_2^2)}\tau^2 \\
&\quad + 2\left(\frac{\text{Cov}(W_1W_2,W_2^2)}{\text{Var}(W_2^2)}\tau^2 - \frac{\text{Cov}(Z,W_1W_2)}{\text{Cov}(Z,W_2^2)}\right)\gamma_1 \\
&\quad + (1-\tau^2)\gamma_1^2 = 0.
\end{align}
$$
