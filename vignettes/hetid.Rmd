...
devtools::install_github("your-github/hetid")
```
...
- **Issues**: Report bugs at [GitHub Issues](https://github.com/your-github/hetid/issues)
- **Citation**: Use `citation("hetid")` for citing the package

## See Also

- [Package website](https://your-website.github.io/hetid/)
- [GitHub repository](https://github.com/your-github/hetid)
