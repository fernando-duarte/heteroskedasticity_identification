...
> **Related vignettes**: For theoretical background, see [Theory and Methods](heteroskedasticity-identification-theory.html). For cross-sectional methods, see [Getting Started](getting-started.html) (Lewbel) or [Rigobon Method](rigobon-method.html) (regime-based).
