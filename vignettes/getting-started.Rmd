...
# Option 2: Using pbapply for progress bar (if available)
# if (requireNamespace("pbapply", quietly = TRUE)) {
#   results <- pbapply::pblapply(1:n_sims, function(i) {
#     run_single_lewbel_simulation(i, sim_params)
#   }) |> bind_rows()
# }
...
- For alternative methods, see [Rigobon](rigobon-method.html) and [Prono](prono-method.html) vignettes
